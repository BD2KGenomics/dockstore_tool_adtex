...
class Options:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('-o','--out', type=str, required=True, 
            help='Output folder name', default='./', action='store', dest='workdir') 
...
def main():
    ...
    workdir = os.path.abspath(tempfile.mkdtemp(dir=options.workdir, prefix="adtex_work_"))
    tmpdir = os.path.join(workdir, 'adtexTmp')
    os.makedirs(tmpdir)
